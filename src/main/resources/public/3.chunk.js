...
/***/ "../../../../../src/app/admin/schedule2/manage-conventional.component.css":
...
var ManageConventionalComponent = (function () {
    function ManageConventionalComponent(dialog, userService, adminComponentService, localStorageService, schedule2Service) {
        ...
        this.today = 0;
        this.swap_cart_struct = { swaps_selection: [] };
        this.filter_by_user = '';
        this.awaiting_cart_struct = { awaitingConfirmation: 0, selected: null, swaps_selection: [] };
    ...
    ManageConventionalComponent.prototype.ngOnInit = function () {
        ...
        this.schedule2Service.getUnconfirmed(function () {
        });
    ...
    ManageConventionalComponent.prototype.generateMonth = function (tmDate) {
        ...
        for (var i = 1, wi = 0;; i++) {
            ...
            week.days.push({ date: day, working: false, shift: shifts_reference, adjecentMonth: adjecentMonth });
            if (i % 7 == 0) {
    ...
    ManageConventionalComponent.prototype.initiate3WaySwap = function (shift) {
        var _this = this;
        this.resetSwap();
        this.loadingSuggestions = true;
        shift.underSwap = true;
        this.revealAssignments([shift]);
        console.log(shift);
        var userIds = [];
        ...
        var date = shift.startTime.getHumanDate() + " (" + shift.startTime.getWeekDay() + ") ";
        var shiftName = this.extractOcShift(shift.shift);
        ...
        this.schedule2Service.suggestSwap3Way(shift.id, shift.assignmentEmployees[0].employee, userIds, function (suggests) {
            //
            // Clear all assignments for whole period for all users
            // 
            for (var u_userId in _this.user_assignments) {
                if (u_userId == 'u_' + _this.selected_user) {
                    continue;
                }
            ...
            var suggest;
            var i = 0;
            while (suggest = suggests.shift()) {
                _this.swap_struct.suggestions.push(suggest);
                //assignment.swapSuggestion = true;
                var day1 = new __WEBPACK_IMPORTED_MODULE_6__model_tmdate__["a" /* TmDate */]();
                day1.date.setTime(suggest[0].dateFrom);
                var day2 = new __WEBPACK_IMPORTED_MODULE_6__model_tmdate__["a" /* TmDate */]();
                day2.date.setTime(suggest[1].dateFrom);
                var suggestion_name = suggest[0].assignmentEmployees[0].employee.firstName + " " +
                    suggest[0].assignmentEmployees[0].employee.lastName + " " +
                    " & " +
                    suggest[1].assignmentEmployees[0].employee.firstName + " " +
                    suggest[1].assignmentEmployees[0].employee.lastName + " (" +
                    day1.getHumanDate() + ", " +
                    day1.getWeekDay() + " & " +
                    day2.getHumanDate() + ", " +
                    day2.getWeekDay() + ")";
                _this.swap_struct.suggestions_selection.push({ value: i, text: suggestion_name });
                i++;
            }
    ...
    ManageConventionalComponent.prototype.initiate2WaySwap = function (shift) {
        ...
        this.schedule2Service.suggestSwap(shift.id, shift.assignmentEmployees[0].employee, userIds, function (assignments) {
            ...
            while (assignment = assignments.shift()) {
                ...
                var suggestion_name = day.getHumanDate() + " (" +
                    day.getWeekDay() + ") " +
                    assignment.assignmentEmployees[0].employee.firstName + " " +
                    assignment.assignmentEmployees[0].employee.lastName;
                _this.swap_struct.suggestions_selection.push({ value: assignment.id, text: suggestion_name });
                ...
                _this.user_assignments[u_userId][t_stamp] = assignment;
    ...
    ManageConventionalComponent.prototype.resetSwap = function () {
        try {
            for (var _i = 0, _a = this.swap_struct.assignments; _i < _a.length; _i++) {
                var sh = _a[_i];
                sh.underSwap = false;
            }
        }
        ...
        this.revealAssignmentsOf(this.selected_user);
        for (var k in this.assignments) {
            this.assignments[k].underSwap = false;
            this.assignments[k].highlighted = false;
            this.assignments[k].justSwapped = false;
            this.assignments[k].suggestion = false;
        }
    };
    ManageConventionalComponent.prototype.cancelSwap = function () {
        var _this = this;
        try {
    ...
    ManageConventionalComponent.prototype.clickAssignment = function (ev, accessor) {
        ...
        if (this.swap_struct && this.swap_struct.type == '2way' && this.swap_struct.assignments) {
            ...
            if (assi1 == this.swap_struct.assignment) {
                ...
                var date = assi1.startTime.getHumanDate() + " (" + assi1.startTime.getWeekDay() + ") ";
                var shiftName = this.extractOcShift(assi1.shift);
    ...
    ManageConventionalComponent.prototype.doubleClickSuggestion = function (item) {
        if (this.swap_struct.type == '2way') {
            //            let date = assi1.startTime.getHumanDate()+" ("+assi1.startTime.getWeekDay()+") ";
            //            let shiftName = this.extractOcShift(assi1.shift);
            //            let employeeName = assi1.assignmentEmployees[0].employee.firstName+" "+assi1.assignmentEmployees[0].employee.lastName;
            //
            //            this.swap_struct.assignments[1] = assi1;
            //            this.swap_struct.assignments_selection[1] = {value: assi1.id, text: date+" ("+shiftName+" shift) "+employeeName};
        }
        else if (this.swap_struct.type == '3way') {
            this.swap_struct.assignments[0] = this.swap_struct.suggestions[item.value][0];
            this.swap_struct.assignments[1] = this.swap_struct.suggestions[item.value][1];
            var sug1Date = this.swap_struct.assignments[0].startTime.getHumanDate() + " (" + this.swap_struct.assignments[0].startTime.getWeekDay() + ") ";
            var sug1Text = this.swap_struct.assignments[0].assignmentEmployees[0].employee.firstName
                + " " + this.swap_struct.assignments[0].assignmentEmployees[0].employee.lastName;
            var shiftName = this.extractOcShift(this.swap_struct.assignments[0].shift);
            this.swap_struct.assignments_selection[1] = { value: 1, text: sug1Date + " (" + shiftName + " shift) " + sug1Text };
            var sug2Date = this.swap_struct.assignments[1].startTime.getHumanDate() + " (" + this.swap_struct.assignments[1].startTime.getWeekDay() + ") ";
            var sug2Text = this.swap_struct.assignments[1].assignmentEmployees[0].employee.firstName
                + " " + this.swap_struct.assignments[1].assignmentEmployees[0].employee.lastName;
            shiftName = this.extractOcShift(this.swap_struct.assignments[1].shift);
            this.swap_struct.assignments_selection[2] = { value: 2, text: sug2Date + " (" + shiftName + " shift) " + sug2Text };
        }
        return false;
    };
    ManageConventionalComponent.prototype.sendSwapToCart = function () {
        var _this = this;
        if (this.swap_struct.type == '2way') {
            this.schedule2Service.twoWaySwap(this.swap_struct.assignments[0], this.swap_struct.assignments[1], function (status) {
                if (status == 'ok') {
                    _this.loadAssignments([{ id: _this.swap_struct.assignments[0].assignmentEmployees[0].employee.id }]);
                    _this.cancelSwap();
                }
            });
        }
        else if (this.swap_struct.type == '3way') {
            this.schedule2Service.threeWaySwap(this.swap_struct.assignments[0], this.swap_struct.assignments[1], this.swap_struct.assignments[2], function (status) {
                if (status == 'ok') {
                    _this.loadAssignments([{ id: _this.swap_struct.assignments[0].assignmentEmployees[0].employee.id }]);
                    _this.cancelSwap();
                }
    ...
    ManageConventionalComponent.prototype.commitCart = function () {
        var swapItems = [];
        for (var _i = 0, _a = this.swap_cart_struct.swaps_selection; _i < _a.length; _i++) {
            var item = _a[_i];
            swapItems.push({ id: item.value });
        }
        this.schedule2Service.commitCart(swapItems, function () {
        });
    };
    ManageConventionalComponent.prototype.revealContextMenu = function (ev) {
        ...
        var shift = {};
        try {
            var displayedShift = eval('this.' + target.dataset.jsaccess + '.shift');
            var u_userId = 'u_' + displayedShift.assignmentEmployees[0].employee.id;
            var t_stamp = 't_' + displayedShift.dateFrom;
            shift = this.user_assignments[u_userId][t_stamp];
        }
        catch (e) {
        }
        var disabled = false;
        try {
            disabled = target.classList.contains('unavailable-for-swap');
        }
        catch (e) {
        }
        var shiftName = this.extractOcShift(shift.shift);
                        ...
                        if (!day.adjecentMonth) {
                            ...
                            if (dayAssignments[0]) {
                                ...
                                for (var _d = 0, dayAssignments_1 = dayAssignments; _d < dayAssignments_1.length; _d++) {
                                    ...
                                    //                                    }
                                    //                                    else {
                                    _this.user_assignments['u_' + userId]['t_' + time] = assignment;
                                    //                                    }
                                }
    ...
    ManageConventionalComponent.prototype.revealAssignmentsOf = function (userId) {
        ...
        //
        this.clearDisplayedAssignments();
        for (var k in this.user_assignments[u_userId]) {
            this.transferProperties(this.user_assignments[u_userId][k], this.assignments[k]);
        }
    };
    ManageConventionalComponent.prototype.clearDisplayedAssignments = function () {
        for (var k in this.assignments) {
            this.clearObject(this.assignments[k]);
        }
    };
    ManageConventionalComponent.prototype.revealAssignments = function (assignments) {
        for (var _i = 0, assignments_2 = assignments; _i < assignments_2.length; _i++) {
            var ass = assignments_2[_i];
            var k = 't_' + ass.dateFrom;
            this.transferProperties(ass, this.assignments[k]);
        }
    };
    ...
    ManageConventionalComponent.prototype.substr3 = function (str) {
        if (str)
    ...
    ManageConventionalComponent.prototype.toggleSwapCart = function () {
        ...
        if (target.classList.contains('fadeIn')) {
            ...
            this.schedule2Service.getSwapCart(function (response) {
                _this.swap_cart_struct.swaps_selection.length = 0;
                for (var _i = 0, response_1 = response; _i < response_1.length; _i++) {
                    var swap = response_1[_i];
                    if (swap.swapType == 'TwoWay') {
                        var date1 = new __WEBPACK_IMPORTED_MODULE_6__model_tmdate__["a" /* TmDate */]();
                        date1.date.setTime(swap.dateFromSwap);
                        var date2 = new __WEBPACK_IMPORTED_MODULE_6__model_tmdate__["a" /* TmDate */]();
                        date2.date.setTime(swap.dateFromSwap2);
                        _this.swap_cart_struct.swaps_selection.push({
                            value: swap.id,
                            text: "TwoWay: " + swap.employee.firstName + " " + swap.employee.lastName +
                                " swaps his " + swap.shiftSwap + " shift (" + date1.getHumanDate() + ") with " +
                                swap.employee2.firstName + " " + swap.employee2.lastName + "'s (" + date2.getHumanDate() + ")"
                        });
                    }
                    else if (swap.swapType == 'TreeWay') {
                        var date1 = new __WEBPACK_IMPORTED_MODULE_6__model_tmdate__["a" /* TmDate */]();
                        date1.date.setTime(swap.dateFromSwap);
                        var date2 = new __WEBPACK_IMPORTED_MODULE_6__model_tmdate__["a" /* TmDate */]();
                        date2.date.setTime(swap.dateFromSwap2);
                        _this.swap_cart_struct.swaps_selection.push({
                            value: swap.id,
                            text: "ThreeWay: " + swap.employee.firstName + " " + swap.employee.lastName +
                                " swaps his " + swap.shiftSwap + " shift (" + date1.getHumanDate() + ") with " +
                                swap.employee2.firstName + " " + swap.employee2.lastName + "'s (" + date2.getHumanDate() + ")"
                        });
                    }
    ...
    ManageConventionalComponent.prototype.toggleAwaitingConfirmation = function () {
        var _this = this;
        var target = document.querySelector('.awaitingCart');
        if (target.classList.contains('fadeIn')) {
            target.classList.remove('fadeIn');
        }
        else {
        ...
        this.schedule2Service.getUnconfirmed(function (response) {
            var c = 0;
            _this.awaiting_cart_struct.swaps_selection.length = 0;
            for (var k in response) {
                for (var _i = 0, _a = response[k]; _i < _a.length; _i++) {
                    var swap = _a[_i];
                    var date1 = new __WEBPACK_IMPORTED_MODULE_6__model_tmdate__["a" /* TmDate */]();
                    date1.date.setTime(swap.dateFromSwap);
                    var date2 = new __WEBPACK_IMPORTED_MODULE_6__model_tmdate__["a" /* TmDate */]();
                    date2.date.setTime(swap.dateFromSwap2);
                    _this.awaiting_cart_struct.swaps_selection.push({
                        value: swap.id,
                        text: swap.swapType + ": Dr. " + swap.employee.firstName + " " + swap.employee.lastName +
                            " swaps his " + swap.shiftSwap + " shift (" + date1.getHumanDate() + ") with " +
                            swap.employee2.firstName + " " + swap.employee2.lastName + "'s (" + date2.getHumanDate() + ")"
                    });
                    c++;
    ...
    ManageConventionalComponent.prototype.confirmSwap = function () {
        if (this.awaiting_cart_struct.selected.value) {
            this.schedule2Service.confirmSwap([{ id: this.awaiting_cart_struct.selected.value }], function () { });
        }
    };
    ManageConventionalComponent.prototype.clickSuggestion = function (suggestion) {
        if (this.swap_struct.type == '2way') {
            var assignmentId = suggestion.value;
            var assignment = void 0;
            for (var _i = 0, _a = this.swap_struct.suggestions; _i < _a.length; _i++) {
                var a = _a[_i];
            ...
            if (assignment) {
                var date = assignment.startTime.getHumanDate() + " (" + assignment.startTime.getWeekDay() + ") ";
                var shiftName = this.extractOcShift(assignment.shift);
                var employeeName = assignment.assignmentEmployees[0].employee.firstName + " " + assignment.assignmentEmployees[0].employee.lastName;
                this.swap_struct.assignments[1] = assignment;
                this.swap_struct.assignments_selection[1] = { value: assignment.id, text: date + " (" + shiftName + " shift) " + employeeName };
                //this.revealAssignmentsOf(assignment.assignmentEmployees[0].employee.id);
                this.clearDisplayedAssignments();
                this.revealAssignments(this.swap_struct.assignments.concat([assignment]));
            }
        }
        else if (this.swap_struct.type == '3way') {
            this.swap_struct.assignments[1] = this.swap_struct.suggestions[suggestion.value][0];
            this.swap_struct.assignments[2] = this.swap_struct.suggestions[suggestion.value][1];
            this.swap_struct.assignments[1].suggestion = true;
            this.swap_struct.assignments[1].highlighted = true;
            this.swap_struct.assignments[2].suggestion = true;
            this.swap_struct.assignments[2].highlighted = true;
            var sug1Date = this.swap_struct.assignments[1].startTime.getHumanDate() + " (" + this.swap_struct.assignments[1].startTime.getWeekDay() + ") ";
            var sug1Text = this.swap_struct.assignments[1].assignmentEmployees[0].employee.firstName
                + " " + this.swap_struct.assignments[1].assignmentEmployees[0].employee.lastName;
            var shiftName = this.extractOcShift(this.swap_struct.assignments[0].shift);
            this.swap_struct.assignments_selection[1] = { value: 1, text: sug1Date + " (" + shiftName + " shift) " + sug1Text };
            var sug2Date = this.swap_struct.assignments[2].startTime.getHumanDate() + " (" + this.swap_struct.assignments[2].startTime.getWeekDay() + ") ";
            var sug2Text = this.swap_struct.assignments[2].assignmentEmployees[0].employee.firstName
                + " " + this.swap_struct.assignments[2].assignmentEmployees[0].employee.lastName;
            shiftName = this.extractOcShift(this.swap_struct.assignments[2].shift);
            this.swap_struct.assignments_selection[2] = { value: 2, text: sug2Date + " (" + shiftName + " shift) " + sug2Text };
            this.clearDisplayedAssignments();
            //this.revealAssignments([this.swap_struct.assignments[0]]);
            this.revealAssignments(this.swap_struct.assignments);
        }
    };
    ManageConventionalComponent.prototype.extractOcShift = function (value) {
        switch (value) {
            case 'OffNight':
            case 'Night':
    ...
    ManageConventionalComponent.prototype.extractDaylightShift = function (value) {
        switch (value) {
            case 'OffLate':
            case 'OffNight':
                return 'Off';
    ...
    ManageConventionalComponent.prototype.extractOcShiftShort = function (value) {
        switch (value) {
            case 'OffNight':
            case 'Night':
            case 'NotWorkingNight':
    ...
    ManageConventionalComponent.prototype.extractDaylightShiftShort = function (value) {
        switch (value) {
            case 'OffLate':
            case 'OffNight':
                return 'Off';
    ...
    ManageConventionalComponent.prototype.extractShifts = function (value) {
        var daylight = this.extractDaylightShiftShort(value);
        var oc = this.extractOcShiftShort(value);
        var label;
        if (oc == 'N') {
            label = oc;
        }
    ...
    ManageConventionalComponent.prototype.changeFilterUser = function (input) {
        if (input == '-') {
            this.swap_struct.suggestions_selection.length = 0;
            for (var _i = 0, _a = this.swap_struct.suggestions; _i < _a.length; _i++) {
                ...
                var suggestion_name = day.getHumanDate() + " (" +
                    ...
                    assignment.assignmentEmployees[0].employee.firstName + " " +
                    assignment.assignmentEmployees[0].employee.lastName;
                this.swap_struct.suggestions_selection.push({ value: assignment.id, text: suggestion_name });
            }
        }
        else {
            this.swap_struct.suggestions_selection.length = 0;
            for (var _b = 0, _c = this.swap_struct.suggestions; _b < _c.length; _b++) {
                var assignment = _c[_b];
                if (assignment.assignmentEmployees[0].employee.id == input) {
                    var day = new __WEBPACK_IMPORTED_MODULE_6__model_tmdate__["a" /* TmDate */]();
                    day.date.setTime(assignment.dateFrom);
                    var suggestion_name = day.getHumanDate() + " (" +
                        day.getWeekDay() + ") " +
...
ManageConventionalComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        template: __webpack_require__("../../../../../src/app/admin/schedule2/manage-conventional.component.html"),
        styles: [__webpack_require__("../../../../../src/app/admin/schedule2/manage-conventional.component.css")],
    }),
...
/***/ "../../../../../src/app/admin/schedule2/manage.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__schedule_component__ = __webpack_require__("../../../../../src/app/admin/schedule2/schedule.component.ts");
...
var ManageComponent = (function () {
    function ManageComponent(router, parentComponent, userService, activityService, 
        ...
        this.grades = [];
        this.grade_model = 'JuniorRegistrar';
        ...
        this.resizeCallback = function (event) {
            ...
            setTimeout(function () {
                ...
                setTimeout(function () { return _this._scaleView(false); }, 0);
            }, 0);
    ...
    ManageComponent.prototype.changeGrade = function (grade) {
        var _this = this;
        this.selectAllVehicles([grade]);
        var vehicleIds = [];
        ...
        setTimeout(function () { return _this.loadAssignments(_this.days[0], timeLength, vehicleIds); }, 0);
        //this._scaleView(true);
    };
    ...
    ManageComponent.prototype._scaleView = function (scaleAssignments) {
        var _this = this;
    ...
    ManageComponent.prototype.resizeTimeLine = function () {
        var vpHeight = window.innerHeight;
        var timelineBox = this.elementCoords(this.mightyParent.nativeElement);
        var createdBy = document.querySelectorAll('.createdBy');
        var createdByBox = this.elementCoords(createdBy[0]);
    ...
    ManageComponent.prototype.selectAllVehicles = function (grades) {
        var _this = this;
        ...
        this.userService._getUsers(0, 1000000, grades).then(function (result) {
            ...
            _this.registrarSchedule.length = 0;
            ...
            setTimeout(function () { return _this._scaleView(true); }, 0);
        });
    };
    ManageComponent.prototype.restoreProperties = function () {
        ...
        this.selectAllVehicles([this.grade_model]);
    };
    ...
    ManageComponent.prototype.removeKnownReferences = function (assignment) {
        var i = -1;
        for (var _i = 0, _a = this.registrarSchedule; _i < _a.length; _i++) {
            var sch = _a[_i];
            if (sch.registrar.id == assignment.assignmentEmployees[0].employee.id) {
                for (var y = 0; y <= sch.assignments.length; y++) {
                    if (sch.assignments[y].id == assignment.id) {
                        i = y;
                        break;
                    }
                }
                if (i != -1) {
                    sch.assignments.splice(i, 1);
                    break;
                }
            }
        }
    ...
    ManageComponent.prototype.assignShift = function (event, shift) {
        ...
        if (!target.classList.contains('disabled')) {
            if (this.assignment_selected) {
                if (shift == 'Unset') {
                    this.schedule2Service.deleteAssignment(this.assignment_selected.id, function () {
                        _this.removeKnownReferences(_this.assignment_selected);
                    });
                }
                else {
    ...
    ManageComponent.prototype.revealContextMenu = function (ev, context, userData) {
        ...
        if (context == 'assignment') {
            this.assignment_selected = userData;
            if (this.assignment_selected.startTime.date.getUTCDay() == 0 || this.assignment_selected.startTime.date.getUTCDay() == 6) {
                shifts = [
                    ...
                    { label: 'Unset', name: 'Unset', disabled: false },
                ];
            }
            else {
                shifts = [
                    { label: 'Late', name: 'Late' },
                    { label: 'Off Late', name: 'OffLate' },
                    { label: 'Annual Late', name: 'AnnualLate' },
                    { label: 'NotWorking Late', name: 'NotWorkingLate' },
                    { label: 'Study Late', name: 'StudyLate' },
                    { label: 'Unset', name: 'Unset', disabled: false },
                    { label: 'Off', name: 'Off' },
                    { label: 'Off Night', name: 'OffNight' },
                    { label: 'Annual Night', name: 'AnnualNight' },
                    { label: 'NotWorking Night', name: 'NotWorkingNight' },
                    { label: 'Study Night', name: 'StudyNight' },
                ];
            }
            ...
            if (startTime.date.getUTCDay() == 0 || startTime.date.getUTCDay() == 6) {
                shifts = [
                    { label: 'OC', name: 'OC' },
                    { label: 'Night', name: 'Night' },
                    { label: 'Unset', name: 'Unset', disabled: true },
                ];
            }
            else {
                shifts = [
        ...
        var left = ev.clientX;
        var top = ev.clientY;
        if (this.contextmenu_struct.itemHeight > 0 && window.innerHeight - ev.clientY < this.contextmenu_struct.itemHeight * shifts.length) {
            top = (ev.clientY) - (this.contextmenu_struct.itemHeight * shifts.length);
        }
        if (this.contextmenu_struct.itemWidth > 0 && window.innerWidth - ev.clientX < this.contextmenu_struct.itemWidth) {
            left = (ev.clientX) - (this.contextmenu_struct.itemWidth);
        }
        shifts.forEach(function (v) {
            itemWidth = v.label.length > itemWidth ? v.label.length : itemWidth;
        });
        this.contextmenu_struct.itemWidth_ch = itemWidth;
        this.contextmenu_struct.top = top;
        this.contextmenu_struct.left = left;
        this.contextmenu_struct.visible = true;
        setTimeout(function () {
            try {
                var item = document.querySelector('.tm_contextmenu .menu_item');
                _this.contextmenu_struct.itemHeight = item.clientHeight;
                _this.contextmenu_struct.itemWidth = item.clientWidth;
            }
            catch (e) {
            }
        }, 0);
    ...
    ManageComponent.prototype.saveAssignment = function (assignment) {
        ...
        this.schedule2Service.saveAssignment(assignment, function (incoming) {
            ...
            for (var i = 1; i < incoming.assignmentList.length; i++) {
                var ass = new __WEBPACK_IMPORTED_MODULE_12__model_schedule__["a" /* Assignment */](incoming.assignmentList[i]);
                ass.startTime = new __WEBPACK_IMPORTED_MODULE_11__model_tmdate__["a" /* TmDate */]();
                ass.startTime.date.setTime(ass.dateFrom);
                ass.timeLength = new __WEBPACK_IMPORTED_MODULE_11__model_tmdate__["b" /* TmLength */]();
                ass.timeLength.seconds = (ass.dateTo - ass.dateFrom) / 1000;
    ...
    ManageComponent.prototype.updateAssignmentLocally = function (assignment, remoteAssignment) {
        ...
        try {
            ...
            assignment.id = remoteAssignment.id;
        }
        catch (e) {
        }
    };
    ...
    ManageComponent.prototype.pushAssignmentLocally = function (assignment) {
        ...
        for (var _i = 0, _a = this.registrarSchedule; _i < _a.length; _i++) {
            ...
            if (schedule.registrar.id == targetRegistrarId) {
                for (var _b = 0, _c = schedule.assignments; _b < _c.length; _b++) {
                    var ass = _c[_b];
                    if ((assignment.id == 0 && assignment.dateFrom == ass.dateFrom) || (assignment.id != 0 && ass.assignmentId == assignment.assignmentId)) {
...
ManageComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        template: __webpack_require__("../../../../../src/app/admin/schedule2/manage.component.html"),
        styles: [__webpack_require__("../../../../../src/app/admin/schedule2/manage.component.css")],
    }),
...
/***/ "../../../../../src/app/admin/schedule2/schedule.component.html":
/***/ (function(module, exports) {
...
/***/ "../../../../../src/app/admin/schedule2/schedule.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var ScheduleComponent2 = (function (_super) {
    ...
    // }
    function ScheduleComponent2(route, router, location, localStorageService, historyService, adminComponent) {
...
ScheduleComponent2 = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        template: __webpack_require__("../../../../../src/app/admin/schedule2/schedule.component.html"),
    }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__schedule_component__ = __webpack_require__("../../../../../src/app/admin/schedule2/schedule.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__manage_component__ = __webpack_require__("../../../../../src/app/admin/schedule2/manage.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__manage_conventional_component__ = __webpack_require__("../../../../../src/app/admin/schedule2/manage-conventional.component.ts");
...
var scheduleRoutes = [
    {
        ...
        children: [
            ...
            { path: 'manage', component: __WEBPACK_IMPORTED_MODULE_6__manage_component__["a" /* ManageComponent */] },
